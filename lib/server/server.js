...
function create (app) {
  // Check if the request is coming over HTTPS based on the X-Forwarded-Proto header.
  var transport = (process.env.HTTPS || req.headers['x-forwarded-proto'] === 'https')
                ? require('https') : require('http');

  if (process.env.HTTPS || req.headers['x-forwarded-proto'] === 'https') {
